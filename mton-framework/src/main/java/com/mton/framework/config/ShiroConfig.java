package com.mton.framework.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import cn.hutool.core.util.ObjectUtil;
import com.mton.framework.shiro.realm.UserRealm;
import com.mton.framework.shiro.session.OnlineSessionDAO;
import com.mton.framework.shiro.session.OnlineSessionFactory;
import com.mton.framework.shiro.web.filter.LogoutFilter;
import com.mton.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.mton.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import com.mton.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.mton.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.mton.framework.shiro.web.session.OnlineWebSessionManager;
import com.mton.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig {
    ...
    public EhCacheManager getEhCacheManager() {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("mton");
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/startrunplan/**","anon");
