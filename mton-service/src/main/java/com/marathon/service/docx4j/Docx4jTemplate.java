...
public class Docx4jTemplate {
    private String inputfilepath = "D:\\profile\\upload\\template\\10.1.1起跑仪式方案.docx";
...
//        documentPart.addStyledParagraphOfText("Title", staticMap.get("title"));
//        documentPart.addStyledParagraphOfText("Subtitle","起跑仪式方案");
    ...
    private HashMap<String, String> getStaticData() {
        ...
        dataMap.put("title", "2020年北京长城马拉松");
        dataMap.put("starttime", "2020年11月11日 7:30");
        dataMap.put("endtime", "11:30");
        dataMap.put("location", "北京鸟巢");
        dataMap.put("participants", newlineToBreakHack("张三\n李四\n王五"));
        dataMap.put("warmShow", "7:30-8:00");
        dataMap.put("athleteWarm", "7:30-8:00");
        dataMap.put("hostOpen", "7:30-8:00");
        dataMap.put("guestShow", "7:30-8:00");
        dataMap.put("introduction", "7:30-8:00");
        dataMap.put("playAnthem", "7:30-8:00");
        dataMap.put("fireGun", "7:30");
        dataMap.put("gameStart", "7:30");
        return dataMap;
    }
