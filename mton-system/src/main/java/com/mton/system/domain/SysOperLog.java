package com.mton.system.domain;

import com.mton.common.annotation.Excel;
...
public class SysOperLog extends BaseEntity {
    ...
    @Excel(name = "请求方法")
    @ApiModelProperty(value="请求方法",name="method",example="com.mton.web.controller.monitor.SysUserOnlineController.forceLogout()")
